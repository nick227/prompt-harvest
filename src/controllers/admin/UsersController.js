...
class UsersController {
    ...
    static async getUsers(req, res) {
        try {
            ...
            const formattedUsers = users.map(user => ({
                ...
                totalGenerated: user._count.images,
                totalPayments: user._count.stripePayments,
                totalTransactions: user._count.creditLedger,
    ...
    static async suspendUser(req, res) {
        try {
            ...
            //     where: { id: userId },
            //     data: { status: 'suspended', suspendedAt: new Date(), suspendedBy: adminUser.id }
            // });

            res.json({
                success: true,
                message: `User suspension logged for ${user.email}`,
                data: {
                    userId,
                    ...
                    note: 'Suspension functionality requires database schema update'
                }
            });
    ...
    static async unsuspendUser(req, res) {
        try {
            ...
            res.json({
                success: true,
                message: `User unsuspension logged for ${user.email}`,
                data: {
                    userId,
                    userEmail: user.email,
                    reason,
                    ...
                    note: 'Unsuspension functionality requires database schema update'
                }
            });
