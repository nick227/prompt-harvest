...
/**
 * Advanced Railway Deployment Script
 * Handles existing table structure and foreign key constraints
 */
...
async function railwayDeployAdvanced() {
    try {
        console.log('🚀 Starting advanced Railway deployment...');
        ...
        // Step 2: Fix table structure without dropping
        console.log('🔧 Step 2: Fixing table structure...');
        await fixTableStructure(tableInfo);
        ...
        console.log('🎉 Advanced Railway deployment successful!');

    } catch (error) {
        console.error('❌ Advanced deployment failed:', error);
        throw error;
    } finally {
...
async function fixTableStructure(tableInfo) {
    try {
...
// Run the deployment
railwayDeployAdvanced()
    .then(() => {
        console.log('🎉 Advanced Railway deployment completed successfully!');
        process.exit(0);
    })
    .catch((error) => {
        console.error('💥 Advanced Railway deployment failed:', error);
        process.exit(1);
    });
