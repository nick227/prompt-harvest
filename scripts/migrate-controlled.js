...
console.log('🚀 Starting controlled data migration...\n');

class ControlledDataMigrator {
    constructor() {
        this.prisma = null;
    ...
    async migrateUsers() {
        ...
        try {
            ...
            this.migrationLog.push(`Users: ${migratedCount} migrated, ${skippedCount} skipped`);
    ...
    async migrateImages() {
        ...
        try {
            ...
            this.migrationLog.push(`Images: ${migratedCount} migrated, ${skippedCount} skipped`);
            console.log(`✅ Images migration completed: ${migratedCount} migrated, ${skippedCount} skipped`);
        } catch (error) {
    ...
    async runMigration() {
        console.log('🚀 Starting controlled data migration from NeDB to MySQL...\n');
        ...
        try {
            ...
            console.log('\n🎉 Controlled migration completed successfully!');
...
if (import.meta.url === `file://${process.argv[1]}`) {
    const migrator = new ControlledDataMigrator();
    migrator.runMigration();
}

export default ControlledDataMigrator;
