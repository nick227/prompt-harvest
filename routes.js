...
const setupImageRoutes = app => {
    ...
    app.post('/image/generate', async(req, res) => {
        ...
        console.log('Server parsed data:', { prompt, providers, guidance, promptId, original, multiplier, mixup, mashup, customVariables });
        ...
        if (needsProcessing) {
            ...
            try {
                ...
                console.log('⚠️ Using original prompt due to error');
            }
        }

        console.log('🔄 Calling feed.image.generate...');
        const response = await feed.image.generate(processedPrompt, original, processedPromptId, providers, guidance, req);
