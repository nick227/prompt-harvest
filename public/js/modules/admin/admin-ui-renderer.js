...
/* global AdminSharedTable, AdminPromoCodeModal, AdminModelsRenderer,
   AdminSummaryRenderer, AdminImageManager, AdminPackageManager, AdminTableRenderer,
...
class AdminUIRenderer {
    constructor() {
        ...
        this.modelsRenderer = new AdminModelsRenderer(this);
        ...
        this.tableRenderer = new AdminTableRenderer(this);
