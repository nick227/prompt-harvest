...
class ImagesManager {
    ...
    checkAutoGenerationContinue() {
        // Check if auto-generation is enabled and should continue
        ...
        // Initialize auto-generation state if not already started
    ...
    triggerNextGeneration() {
        ...
        // Simulate button click to trigger normal generation flow
        const startButton = document.querySelector('.btn-generate');

        if (startButton && !this.ui.isGenerating) {
            startButton.click();
        }
    }
