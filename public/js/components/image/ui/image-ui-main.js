...
import { FullscreenComponents } from './fullscreen-components.js';
...
export class ImageUI {
    ...
    createFullscreenContainer() {
        return this.fullscreenComponents.createFullscreenContainer();
    }
    ...
    createInfoBox(imageData) {
        ...
        return this.fullscreenComponents.createInfoBox(imageData);
    }
