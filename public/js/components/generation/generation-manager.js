...
class GenerationManager {
    ...
    async generateImage(promptObj) {
        ...
        try {
            ...
            if (typeof window.generateImage === 'function') {
                ...
                console.error('❌ window.generateImage function not found');
    ...
    generateNextImage() {
        console.log('🔄 AUTO-GENERATE: Triggering next image generation');
        ...
        if (startButton) {
            console.log('🔄 AUTO-GENERATE: Simulating START button click');
            startButton.click();
        } else {
            console.error('❌ AUTO-GENERATE: START button not found, falling back to direct generation');
    ...
    handleError(error, context = '') {
        console.error(`❌ Generation Manager Error${context ? ` (${context})` : ''}:`, error);
